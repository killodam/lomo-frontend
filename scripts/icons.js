/* Shared inline-SVG icon set (line style, 24x24, stroke=currentColor) —
   replaces recurring functional emoji. Decorative one-off emoji (landing,
   info screens, onboarding, AI template chips) intentionally stay emoji. */
...
var LOMO_ICONS = {
  ...
  'building': '<path d="M3 22h18"/><path d="M6 22V4a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v18"/><path d="M10 7h1"/><path d="M13 7h1"/><path d="M10 11h1"/><path d="M13 11h1"/><path d="M10 15h1"/><path d="M13 15h1"/>',
  ...
  'ruble': '<circle cx="12" cy="12" r="10"/><path d="M10 17V7h3.2a2.9 2.9 0 0 1 0 5.8H8.6"/><path d="M8.6 14.6h5"/>',
...
function lomoIcon(name, cls) {
  var body = LOMO_ICONS[name];
  if (!body) return '';
  return '<svg class="lomoIco' + (cls ? ' ' + cls : '') + '" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' + body + '</svg>';
}
