...
var faqData = [
  ...
  },
  {
    ...
    a: 'При удалении аккаунта все данные и документы удаляются в течение 30 дней. Работодатели теряют доступ к профилю мгновенно.'
  },
  // ─── Работодателям ───────────────────────────────────────
  {
    cat: 'employer',
  ...
  {
    cat: 'employer',
    q: 'Что означают уровни верификации LOMO 1, 2, 3?',
    a: 'LOMO 1 — подтверждена электронная почта. LOMO 2 — подтверждена личность (паспорт или аналогичный документ, проверен модератором). LOMO 3 — подтверждены опыт работы и/или образование (трудовая книжка, справка, диплом или сертификат — достаточно одного документа). Уровни кумулятивные: нельзя получить LOMO 3 без подтверждённых почты и личности.'
  },
  {
    cat: 'employer',
