  ...
  return '';
    ...
    document.addEventListener('click', (e) => {
      ...
      if (templateChip && templateChip.closest('#aiMatchModal')) {
        const templates = {
          // Finance & Economics
          finanalyst: 'Ищем финансового аналитика. Задачи: финансовое моделирование, анализ P&L, бюджетирование, подготовка управленческой отчётности по МСФО и РСБУ, прогнозирование. Требования: опыт в финансах от 2 лет, Excel на уровне продвинутого пользователя, знание МСФО или РСБУ, PowerPoint. Формат: офис или гибрид.',
          accountant: 'Ищем бухгалтера. Задачи: ведение бухгалтерского и налогового учёта, подготовка деклараций, работа с первичной документацией, сдача отчётности в ФНС. Требования: знание РСБУ, уверенный пользователь 1С:Бухгалтерия, понимание налогового законодательства, опыт от 1 года.',
          economist: 'Ищем экономиста. Задачи: экономический анализ, прогнозирование, планирование бюджета, расчёт себестоимости, подготовка финансово-экономических отчётов и показателей. Требования: высшее экономическое образование, Excel, навыки статистического анализа и бюджетирования, опыт от 1 года.',
          // IT
          ...
          // Other professions
          hr: 'Ищем HR-менеджера / специалиста по подбору персонала. Задачи: полный цикл рекрутмента, онбординг, адаптация сотрудников, ведение кадрового делопроизводства, HR-аналитика. Требования: опыт подбора персонала от 1 года, знание трудового законодательства, навыки интервьюирования.',
          marketing: 'Ищем маркетолога / специалиста по digital-маркетингу. Задачи: разработка маркетинговой стратегии, SEO, SMM, таргетированная и контекстная реклама, анализ рынка и конкурентов. Инструменты: Google Analytics, Яндекс.Метрика, CRM. Опыт от 1 года.',
        };
        var ta = document.getElementById('aiMatchTextarea');
        if (ta) {
