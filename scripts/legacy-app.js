...
const list = document.getElementById('epPortfolioList');
  ...
  const panels={
    ...
    privacy:{title:'Политика конфиденциальности',html:'<p style="margin:0 0 10px">Собираем минимум данных: имя, email, документы.</p><p style="margin:0 0 10px">Телефон и email не публикуются публично.</p><p style="margin:0">Запрос удаления: <b>support@lomo.website</b></p>'},
    ...
    function openLegalModal(type){
      ...
      if(type === 'terms'){
        ...
        body.innerHTML = `
          ...
          <p>Пользователь вправе запросить удаление своего аккаунта и всех связанных данных. Запрос обрабатывается в течение 30 дней.</p>
          <h3>5. Cookies</h3>
